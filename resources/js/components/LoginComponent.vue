                ...
                <div id="formContent">
                    ...
                    <div class="form-group">
                        <input v-model="form.email" type="text" name="email"  placeholder="E-mail"
                               class="fadeIn second" :class="{ 'is-invalid': form.errors.has('email') }">
                        <has-error :form="form" field="email"></has-error>
                    </div>

                    <div class="form-group">
                        <input v-model="form.password" type="password" name="password" placeholder="Senha"
                               class="fadeIn third" :class="{ 'is-invalid': form.errors.has('password') }">
                ...
                this.form.post('/api/v1/login')
                    .then(response => {
                        if(this.form.successful)
                        {
                            ...
                            console.log('erro');
                            this.$Progress.fail()
                            this.$snotify.error('Ocorreu um erro ao efetuar o login', 'Erro')
                        }
                    })
                    .catch(e => {
                        this.$snotify.error('Ocorreu um erro ao efetuar o login', 'Erro')
