...
return [
    ...
    */
    ...
    'before_or_equal'      => ':attribute deve ser uma data antes ou igual á :date.',
    'between'              => [
    ...
    */
    'attributes' => [
        'telefone[]' => 'Telefone',
        'roteiro.data' => 'Data da visita',
        'roteiro.hora' => 'Horário da visita',
        'roteiro.comentarios' => 'Comentários',
        'roteiro.imovel' => 'imóvel',
        'atendimento.cliente_id' => 'Cliente',
        'atendimento.comentarios' => 'Comentários',
        'atendimento.user_id' => 'Quem vai atender',
        'outros.titulo' => 'Título',
        'outros.data_de' => 'Data de',
        'outros.hora_de' => 'Horário de',
        'outros.data_ate' => 'Data até',
        'outros.hora_ate' => 'Horário até',
        'outros.comentarios' => 'Comentários',
        'telefones.*.prefixo' => 'Prefixo',
        'telefones.*.numero' => 'Telefone',
        'telefones.*.operadora' => 'Operadora',
