    ...
    */
    'security' => [
        ...
        */
        ...
        'passaport' => [ // Unique name of security
...
//            //'authorizationUrl' => 'http://localhost//users/auth', // The authorization URL to be used for (implicit/accessCode)
//            'tokenUrl' => 'http://localhost//users/auth', // The authorization URL to be used for (password/application/accessCode)
//            'scopes' => [
...
//                    "tokenUrl" => config('app.url') . '/api/v1/users/auth',
